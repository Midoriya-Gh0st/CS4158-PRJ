...
#line 108 "parse.tab.c" /* yacc.c:339  */
...
{
       0,    63,    63,    65,    67,    68,    70,    71,    75,    77,
      78,    80,    80,    80,    80,    82,    83,    84,    86,    87,
      88,    92,    94,    95,    97,    99,   100,   101,   102,   106
};
#endif
...
{
  "$end", "error", "$undefined", "ival", "dval", "isize", "dsize", "id",
  "text", "sem", "comma", "start", "end", "t_main", "move", "add", "to",
  "etv", "et", "t_input", "t_print", "$accept", "PRGM", "HEAD", "DECLS",
  "DECL", "BODY", "OPS", "OP", "EQUAL", "ADD", "INPUT", "INPUT_ARGS",
  "PRINT", "PRINT_ARGS", "TAIL", YY_NULLPTR
};
#endif
...
{
      -8,     2,     7,    14,   -46,   -46,    19,    12,     4,   -46,
      20,   -46,    23,    24,   -46,    -7,   -46,    25,    26,    -3,
      -2,    29,     9,   -46,   -46,   -46,   -46,   -46,   -46,   -46,
      15,    30,    17,    22,    27,    11,   -46,    13,    16,   -46,
      31,    32,    33,    37,    38,    39,   -46,    29,   -46,     9,
     -46,     9,   -46,   -46,   -46,    40,    41,    42,   -46,   -46,
     -46,   -46,   -46,   -46
};
...
{
       0,     0,     0,     0,     5,     1,     0,     0,     3,    10,
       0,     2,     0,     0,     4,     8,    29,     0,     0,     0,
       0,     0,     0,     9,    11,    12,    13,    14,     6,     7,
       0,     0,     0,     0,     0,     0,    21,     0,     0,    24,
       0,     0,     0,     0,     0,     0,    23,     0,    28,     0,
      27,     0,    17,    16,    15,     0,     0,     0,    22,    26,
      25,    19,    20,    18
};
...
{
      19,    32,    33,     1,    59,    34,    60,     5,    20,    12,
      13,     4,    21,    22,    30,    31,    37,    38,    40,    41,
      46,    47,    48,    49,    10,    50,    51,     6,     9,    16,
      17,    18,    58,    43,    28,    29,    35,    42,    44,     0,
      52,    53,    54,    45,    55,    56,    57,     0,     0,    61,
      62,    63
};

static const yytype_int8 yycheck[] =
{
       7,     3,     4,    11,    49,     7,    51,     0,    15,     5,
       6,     9,    19,    20,    17,    18,     7,     8,     3,     4,
       9,    10,     9,    10,    12,     9,    10,    13,     9,     9,
       7,     7,    47,    16,     9,     9,     7,     7,    16,    -1,
       9,     9,     9,    16,     7,     7,     7,    -1,    -1,     9,
       9,     9
};
...
{
       0,    11,    22,    23,     9,     0,    13,    26,    24,     9,
      12,    35,     5,     6,    25,    27,     9,     7,     7,     7,
      15,    19,    20,    28,    29,    30,    31,    33,     9,     9,
      17,    18,     3,     4,     7,     7,    32,     7,     8,    34,
       3,     4,     7,    16,    16,    16,     9,    10,     9,    10,
       9,    10,     9,     9,     9,     7,     7,     7,    32,    34,
      34,     9,     9,     9
};
...
#line 70 "parse.y" /* yacc.c:1646  */
    { printf("Int-> %s\n", (yyvsp[-1].str)); getSizeX((yyvsp[-2].i_size)); idUppercase1((yyvsp[-1].str)); storeVar(CurId, TYPE_I, CurSize_I, -1);}
#line 1326 "parse.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 71 "parse.y" /* yacc.c:1646  */
    { printf("Double-> %s\n", (yyvsp[-1].str)); getSizeX((yyvsp[-2].d_size)); idUppercase1((yyvsp[-1].str)); storeVar(CurId, TYPE_D, CurSize_I, CurSize_D);}
